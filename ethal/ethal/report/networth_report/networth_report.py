...
from erpnext.accounts.report.balance_sheet.balance_sheet import get_provisional_profit_loss, check_opening_balance
...
# def get_provisional_profit_loss(asset, liability, equity=False, period_list, company, currency=None, consolidated=False):
...
# 			total_row[key] = flt(asset[-2].get(key)) - flt(liability[-2].get(key))
...
def get_additional_conditions(from_date, ignore_closing_entries, filters):
	...
	if filters:
		...
		# 	additional_conditions.append("(account in %(account)s)")
